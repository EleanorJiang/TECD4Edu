...
#entity_2_name = "self-concept"
#entity_2_name = "self-esteem"
...
def main():
	...
	out_filename =  "step1_output_esteem.json"
...
#have to define it like this because "sixth" is not tagged as a numeral by spacy
schoolyears = ["first","second","third","fourth","fifth","sixth","seventh","eighth","ninth", "tenth", "eleventh", "twelvth", "-", 
				"1st", "2nd", "3rd", "4th", "5th", "6th", "7th", "8th", "9th", "10th", "11th", "12th"]

# entities 1: school years and transitions
ent1patterns = [
	[{"LOWER": {"REGEX": "transitions?"}}],  
	[ {"LOWER": {"IN": schoolyears } } , {"LOWER": {"IN": ["grade","grades","year","years"]}}],
	[ {"LOWER": {"IN": ["high","middle"]}}, {"IS_PUNCT": True, "OP":"?"}, {"LOWER":"school" }],
	[ {"LOWER": {"IN": ["highschool","middleschool"]}}],
	]
matcher.add("year", ent1patterns,  on_match=add_ent1)


# entity2: motivational variables
ent2patterns = [
	[{"LOWER": "self"}, {"IS_PUNCT": True, "OP":"?"} ,{"LOWER": {"REGEX": "esteems?"}}],
	[{"LOWER": "self"}, {"IS_PUNCT": True, "OP":"?"} ,{"LOWER": {"REGEX": "concepts?"}}],
	[{"LOWER": "self"}, {"IS_PUNCT": True, "OP":"?"} ,{"LOWER": {"REGEX": "efficac[(ie)y]s?"}}]	,
	[{"LOWER": "intrinsic"}, {"LOWER": {"REGEX": "motivations?"}}],
	[{"LOWER": "achievement"}, {"LOWER": {"REGEX": "goals?"}}],
	]
matcher.add("motivation", ent2patterns, on_match=add_ent2)
