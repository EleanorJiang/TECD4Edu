#does the mention extraction, but outputs in a format compatible with the online annotation tool
...
def main():
	...
	for filename in os.listdir(directory):
		...
		if (counter not in [15, 60, 10, 13, 14, 17, 61]):
			continue
	...
	out_filename = "step1_output_concept_online_format.json"
...
ent1patterns = [
	...
	[{"LOWER": {"IN":["academic", "school"]}},{"LOWER": "performance"}],
	]
